...
public class Start_Arm_Exercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_arm_exercise);
        ...
        floatingActionButtonPrevious.setOnClickListener(view -> {
            if (currentFlag <= 0) {
                Toast.makeText(Start_Arm_Exercise.this, "No Skip Previous", Toast.LENGTH_SHORT).show();
            } else {
                currentFlag--;
                finishExercise(currentFlag);
            }
        ...
        floatingActionButton.setOnClickListener(view -> {
            ...
            // ||||||||||||||||| Skip and Previous Btn ||||||||||||||||||||||
            if (currentFlag == 0) {
                exerciseStart(R.raw.punches, "1. Dumbbell Punches");
            } else if (currentFlag == 1) {
                exerciseStart(R.raw.military_push_ups, "2. Military Push Ups");
            } else if (currentFlag == 2) {
                exerciseStart(R.raw.jumping_jack, "3. Jumping Jack");
            } else if (currentFlag == 3) {
                exerciseStart(R.raw.t_plank_excercise, "4. T Plank Exercise");
            } else if (currentFlag == 4) {
                exerciseStart(R.raw.staggered_push_ups, "5. Staggered Push Ups");
            } else if (currentFlag == 5) {
                exerciseStart(R.raw.shoulder_stretch, "6. Shoulder Stretch");
            } else if (currentFlag == 6) {
                exerciseStart(R.raw.inchworm, "7. Inchworm");
    ...
    protected void onResume() {
        ...
        if (currentFlag == 0) {
            dialogBox("First Exercise is Punches", R.raw.punches_voice);
            firstTimeIntro(R.raw.punches, "1. Dumbbell Punches");
        } else if (currentFlag == 1) {
            dialogBox("Next Exercise is Military Push Up", R.raw.military_push_ups_voice);
            firstTimeIntro(R.raw.military_push_ups, "2. Military Push Ups");
        } else if (currentFlag == 2) {
            dialogBox("Next Exercise is Jumping Jack", R.raw.jumping_jack_voice);
            firstTimeIntro(R.raw.jumping_jack, "3. Jumping Jack");
        } else if (currentFlag == 3) {
            dialogBox("Next Exercise is T Plank", R.raw.t_plank_exercise_voice);
            firstTimeIntro(R.raw.t_plank_excercise, "4. T Plank Exercise");
        } else if (currentFlag == 4) {
            dialogBox("Next Exercise is Staggered Push Up", R.raw.straggered_push_ups_voice);
            firstTimeIntro(R.raw.staggered_push_ups, "5. Staggered Push Ups");
        } else if (currentFlag == 5) {
            dialogBox("Next Exercise is Shoulder Stretch", R.raw.shoulder_stretch_voice);
            firstTimeIntro(R.raw.shoulder_stretch, "6. Shoulder Stretch");
        } else if (currentFlag == 6) {
            dialogBox("Next Exercise is Inchworm", R.raw.inchworm_voice);
            firstTimeIntro(R.raw.inchworm, "7. Inchworm");
        } else if (currentFlag == 7) {
    ...
    public void dialogBox(String bmiDesc, int exNameVoice) {
        dialog = new Dialog(Start_Arm_Exercise.this);
    ...
    private void displayDatabaseInfo() {
        ...
        try (Cursor cursor = db.query(
            ...
            while (cursor.moveToNext()) {
                ...
                currentFlag = cursor.getInt(flagColumnIndexArm);
            }
        }
    }
...
//        cv.put("Field1","Bob"); //These Fields should be your String values of actual column names
        cv.put(SchemaContract.CounterEntry.COLUMN_FLAG_ARM, updateValue);
