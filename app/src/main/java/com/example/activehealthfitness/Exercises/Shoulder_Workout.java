...
import com.example.activehealthfitness.StartExercises.Start_Shoulder_Exercise;
...
public class Shoulder_Workout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseWorkout.add(new ExerciseWorkout("T Plank", "X30", R.raw.t_plank_excercise));
        exerciseWorkout.add(new ExerciseWorkout("Wide Arm Push Up", "X30", R.raw.wide_arm_push_up));
        exerciseWorkout.add(new ExerciseWorkout("Shoulder Stretch", "X30", R.raw.shoulder_stretch));
        ...
        listView.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            if (i == 0) {
                Intent intent = new Intent(Shoulder_Workout.this, Exercise_Detail.class);
                intent.putExtra("animation", R.raw.t_plank_excercise);
                intent.putExtra("name", "T Plank");
                intent.putExtra("desc", getString(R.string.t_plank));
        ...
        startExerciseBtn.setOnClickListener(view -> Shoulder_Workout.this.startActivity(new Intent(Shoulder_Workout.this, Start_Shoulder_Exercise.class)));
    }
