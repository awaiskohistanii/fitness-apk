...
import com.example.activehealthfitness.StartExercises.Start_Arm_Exercise;
...
public class Arm_Workout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Arm");
        }
        ...
        exerciseWorkout.add(new ExerciseWorkout("Military Push Up", "X20", R.raw.military_push_ups));
        ...
        listView.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            if (i==0)
            {
                Intent intent = new Intent(Arm_Workout.this, Exercise_Detail.class);
        ...
        startExerciseBtn.setOnClickListener(view -> startActivity(new Intent(Arm_Workout.this, Start_Arm_Exercise.class)));
    }
