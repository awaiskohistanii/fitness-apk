...
public class Start_Chest_Exercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_chest_exercise);
        ...
        floatingActionButtonPrevious.setOnClickListener(view -> {
            if (currentFlag <= 0) {
                Toast.makeText(Start_Chest_Exercise.this, "No Skip Previous", Toast.LENGTH_SHORT).show();
            } else {
                currentFlag--;
                finishExercise(currentFlag);
            }
        ...
        floatingActionButton.setOnClickListener(view -> {
            ...
            // ||||||||||||||||| Skip and Previous Btn ||||||||||||||||||||||
            if (currentFlag == 0) {
                exerciseStart(R.raw.wide_arm_push_up, "1. Wide Arm push Up");
            } else if (currentFlag == 1) {
                exerciseStart(R.raw.punches, "2. Dumbbell Punches");
            } else if (currentFlag == 2) {
                exerciseStart(R.raw.staggered_push_ups, "3. Staggered push Ups");
            } else if (currentFlag == 3) {
                exerciseStart(R.raw.shoulder_stretch, "4. Shoulder Stretch");
            } else if (currentFlag == 4) {
                exerciseStart(R.raw.military_push_ups, "5. Military Push Ups");
            } else if (currentFlag == 5) {
                exerciseStart(R.raw.reverse_crunches, "6. Reverse Crunches");
            } else if (currentFlag == 6) {
                exerciseStart(R.raw.jumping_jack, "7. Jumping Jack");
    ...
    protected void onResume() {
        ...
        if (currentFlag == 0) {
            dialogBox("First Exercise is Wide Arm Push Up", R.raw.wide_arm_push_ups_voice);
            firstTimeIntro(R.raw.wide_arm_push_up, "1. Wide Arm push Up");
        } else if (currentFlag == 1) {
            dialogBox("Next Exercise is Punches", R.raw.punches_voice);
            firstTimeIntro(R.raw.punches, "2. Dumbbell Punches");
        } else if (currentFlag == 2) {
            dialogBox("Next Exercise is Staggered Push Up", R.raw.straggered_push_ups_voice);
            firstTimeIntro(R.raw.staggered_push_ups, "3. Staggered push Ups");
        } else if (currentFlag == 3) {
            dialogBox("Next Exercise is Shoulder Stretch", R.raw.shoulder_stretch_voice);
            firstTimeIntro(R.raw.shoulder_stretch, "4. Shoulder Stretch");
        } else if (currentFlag == 4) {
            dialogBox("Next Exercise is Military Push Up", R.raw.military_push_ups_voice);
            firstTimeIntro(R.raw.military_push_ups, "5. Military Push Ups");
        } else if (currentFlag == 5) {
            dialogBox("Next Exercise is Reverse Crunches", R.raw.reverse_crunches_voice);
            firstTimeIntro(R.raw.reverse_crunches, "6. Reverse Crunches");
        } else if (currentFlag == 6) {
            dialogBox("Next Exercise is Jumping Jack", R.raw.jumping_jack_voice);
            firstTimeIntro(R.raw.jumping_jack, "7. Jumping Jack");
        } else if (currentFlag == 7) {
    ...
    public void dialogBox(String bmiDesc, int exNameVoice) {
        dialog = new Dialog(Start_Chest_Exercise.this);
        ...
        heading.setText("Chest Exercise");
    ...
    private void displayDatabaseInfo() {
        ...
        try (Cursor cursor = db.query(
            ...
            while (cursor.moveToNext()) {
                ...
                currentFlag = cursor.getInt(flagColumnIndexChest);
            }
        }
    }
...
//        cv.put("Field1","Bob"); //These Fields should be your String values of actual column names
        cv.put(SchemaContract.CounterEntry.COLUMN_FLAG_CHEST, updateValue);
