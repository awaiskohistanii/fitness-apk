...
public class Start_Leg_Exercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_leg_exercise);
        ...
        floatingActionButtonPrevious.setOnClickListener(view -> {
            if (currentFlag <= 0) {
                Toast.makeText(Start_Leg_Exercise.this, "No Skip Previous", Toast.LENGTH_SHORT).show();
            } else {
                currentFlag--;
                finishExercise(currentFlag);
            }
        ...
        floatingActionButton.setOnClickListener(view -> {
            ...
            // ||||||||||||||||| Skip and Previous Btn ||||||||||||||||||||||
            if (currentFlag == 0) {
                exerciseStart(R.raw.squat_kicks, "1. Squat Kicks");
            } else if (currentFlag == 1) {
                exerciseStart(R.raw.reverse_crunches, "2. Reverse Crunches");
            } else if (currentFlag == 2) {
                exerciseStart(R.raw.inchworm, "3. Inchworm");
            } else if (currentFlag == 3) {
                exerciseStart(R.raw.jumping_jack, "4. Jumping Jack");
            } else if (currentFlag == 4) {
                exerciseStart(R.raw.seated_abs_circles, "5. Seated Abs Circles");
            } else if (currentFlag == 5) {
                exerciseStart(R.raw.jumping_squats, "6. Jumping Squats");
            } else if (currentFlag == 6) {
                exerciseStart(R.raw.squat_reach, "7. Squat Reach");
            } else if (currentFlag == 7) {
                exerciseStart(R.raw.single_leg_hip_rotation, "8. Single Leg Rotation");
            } else {
                completeExercise();
            }
        });
    ...
    protected void onResume() {
        ...
        if (currentFlag == 0) {
            dialogBox("First Exercise is Squat Kicks", R.raw.squat_kicks_voice);
            firstTimeIntro(R.raw.squat_kicks, "1. Squat Kicks");
        } else if (currentFlag == 1) {
            dialogBox("Next Exercise is Reverse Crunches", R.raw.reverse_crunches_voice);
            firstTimeIntro(R.raw.reverse_crunches, "2. Reverse Crunches");
        } else if (currentFlag == 2) {
            dialogBox("Next Exercise is Inchworm", R.raw.inchworm_voice);
            firstTimeIntro(R.raw.inchworm, "3. Inchworm");
        } else if (currentFlag == 3) {
            dialogBox("Next Exercise is Jumping Jack", R.raw.jumping_jack_voice);
            firstTimeIntro(R.raw.jumping_jack, "4. Jumping Jack");
        } else if (currentFlag == 4) {
            ...
            dialogBox("Next Exercise is Jumping Squats", R.raw.jumping_squats_voice);
            firstTimeIntro(R.raw.jumping_squats, "6. Jumping Squats");
        } else if (currentFlag == 6) {
            dialogBox("Next Exercise is Squat Reach", R.raw.squat_reach_voice);
            firstTimeIntro(R.raw.squat_reach, "7. Squat Reach");
        } else if (currentFlag == 7) {
            dialogBox("Last Exercise is Single Leg Hip", R.raw.single_leg_hip_voice);
            firstTimeIntro(R.raw.single_leg_hip_rotation, "8. Single Leg Rotation");
        } else {
            completeExercise();
        }
    }
    ...
    public void dialogBox(String bmiDesc, int exNameVoice) {
        dialog = new Dialog(Start_Leg_Exercise.this);
    ...
    private void displayDatabaseInfo() {
        ...
        try (Cursor cursor = db.query(
            ...
            while (cursor.moveToNext()) {
                ...
                currentFlag = cursor.getInt(flagColumnIndexLeg);
            }
        }
    }
...
//        cv.put("Field1","Bob"); //These Fields should be your String values of actual column names
        cv.put(SchemaContract.CounterEntry.COLUMN_FLAG_LEG, updateValue);
